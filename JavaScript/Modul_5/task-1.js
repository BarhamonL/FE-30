...
// В prototype функции-конструктора добавь
// метод getInfo(), который выводит в консоль
// значения полей login и email объекта который
// его вызвал.
...
// mango.getInfo(); // Login: Mangozedog, Email:
// mango@dog.woof
